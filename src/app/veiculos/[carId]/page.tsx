                ...
                <div className="grid grid-cols-2 w-full my-4 rounded-lg bg-gray-100 p-10">
                        ...
                        <Slider>
                            {
                                ...
                                car.ImageCars.map((image) => (
                                    <img key={car.id} src={`http://localhost:3333/${image.source}`} alt="Imagem do carro" />
                                ))
                            }
                        </Slider>
                    </div>
                    <div className="flex flex-col items-center justify-start gap-10 bg-gray-50 rounded-lg mx-36 p-10">
                        ...
                        <ul className="w-full flex flex-row gap-28 items-center justify-around mt-4 border-b-bottom border-red-700">
                            ...
                            <ul className="flex flex-col gap-3 w-full">
                                <li className="flex gap-3 my-2"><strong className="uppercase text-red-600 text-1xl">Marca</strong></li>
                                ...
                                <li className="flex gap-3 my-2"><strong className="uppercase text-red-600 text-1xl">Gasolina</strong></li>
