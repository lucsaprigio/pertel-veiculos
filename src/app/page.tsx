...
export default function Home() {
  return (
    <main>
      ...
      <div id="carros-estoque-destaque" className="flex flex-col gap-4 px-14 py-10 items-start justify-start w-full h-full mb-64">
        <h2 className="text-4xl text-red-700 font-bold mt-8 font-inter">Novidades</h2>
        <div className="flex flex-col items-center justify-center xl:grid xl:grid-cols-1 gap-3 w-full">
          ...
          <div className="flex flex-col items-center xl:flex-row xl:items-start gap-2 justify-start w-auto">
            <PromotionCard
              source="/images/car.jpg"
              description="Descrição de teste"
              price={199999}
