...
export function Header() {
    ...
    return (
        <aside className={`relative flex w-full p-10 h-16 shadow-xl bg-gradient-to-b from-red-800 to-red-700 z-50 ${visible ? 'translate-y-0' : '-translate-y-full transform transition-all duration-200'}`}>
